...
maths_treatment<-c("BTBM19A", "BTBM19B")

#maths_treatment2 <- c("BTBM20A", "BTBM20B", "BTBM20C", "BTBM20D", "BTBM20E")
...
science_treatment<-c("BTBS18A", "BTBS18B")

#science_treatment2 <- c("BTBS19A", "BTBS19B", "BTBS19C", "BTBS19D", "BTBS19E")
...
from<-c("Girl","Boy","Omitted or invalid",
        ...
        "Every day", "3 or 4 times a week", "1 or 2 times a week", "Less than once a week", "I do not assign mathematics homework", "I do not assign science homework",
        "My teacher never gives me homework in…", "15 minutes or less", "16–30 minutes", "31–60 minutes", "61–90 minutes", "More than 90 minutes",
...
DurationM<-XY$BTBM19B
DurationS<-XY$BTBS18B

FrequencyM<-XY$BTBM19A
FrequencyS<-XY$BTBS18A
...
table_df$Subject<-c(rep("Mathematics", 25), rep("Science", 30))
...
my_mod <- fast_bart(X1, 
                    ...
                    2)
#save results
save(my_mod, file = "ModelResultsChain2.RData", compress = "xz")
...
my_mod <- fast_bart(X1, 
                    ...
                    2)
#save results
save(my_mod, file = "ModelResultsChain3.RData", compress = "xz")
...
my_mod <- fast_bart(X1, 
                    ...
                    2)
#save results
save(my_mod, file = "ModelResultsChain4.RData", compress = "xz")
...
my_mod <- fast_bart(X1, 
                    ...
                    2)
#save results
save(my_mod, file = "ModelResultsChain5.RData", compress = "xz")
