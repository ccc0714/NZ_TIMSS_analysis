...
load("2023Data/bcgnzlm8.rdata")
load("2023Data/bsgnzlm8.rdata")
load("2023Data/bstnzlm8.rdata")
load("2023Data/btmnzlm8.rdata")
load("2023Data/btsnzlm8.rdata")
...
Y<-cbind(impute_XY$BSMMAT02.x, impute_XY$BSSSCI02.x)
...
Y<-cbind(impute_XY$BSMMAT03.x, impute_XY$BSSSCI03.x)
...
Y<-cbind(impute_XY$BSMMAT04.x, impute_XY$BSSSCI04.x)
...
Y<-cbind(impute_XY$BSMMAT05.x, impute_XY$BSSSCI05.x)
