...
load("yourdirectory/bcgnzlm8.rdata")
load("yourdirectory/bsgnzlm8.rdata")
load("yourdirectory/bstnzlm8.rdata")
load("yourdirectory/btmnzlm8.rdata")
load("yourdirectory/btsnzlm8.rdata")
