...
science_treatment<-c("BTBS19A", "BTBS19B", "BTBS19C", "BTBS19D", "BTBS19E")
...
XYM<-mutate_at(XYM, c(2:9, 16:25, 27:28, 34, 38:43, 53:57), mymap2)
XYS<-mutate_at(XYS, c(2:9, 16:25, 27:28, 34, 38:43, 53:57), mymap2)
...
Q1M <- XY$BTBM20A #Observing student as they work on math
Q1S <- XY$BTBS19A #Observing student as they work on science

Q2M <- XY$BTBM20B #Asking students to answer questions during math class
Q2S <- XY$BTBS19B #Asking students to answer questions during science class

Q3M <- XY$BTBM20C #Short, regular written math assessments
Q3S <- XY$BTBS19C #Short, regular written science assessments 

Q4M <- XY$BTBM20D #Longer math test (unit tests or exams)
Q4S <- XY$BTBS19D #Longer science test (unit tests or exams)

Q5M <- XY$BTBM20E #Long-term math projects
Q5S <- XY$BTBS19E #Long-term science projects
...
Z1<-cbind(Z1, Z2) #Observing student as they work
Z2<-cbind(Z3, Z4) #Asking students to answer questions during class
Z3<-cbind(Z5, Z6) #Short, regular written assessments
Z4<-cbind(Z7, Z8) #Longer test (unit tests or exams)
Z5<-cbind(Z9, Z10) #Long-term projects
#Reference level for all question is "some/never"
